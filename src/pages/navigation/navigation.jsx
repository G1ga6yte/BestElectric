...
function Navigation () {
    ...
    return(
       state && <div style={{minHeight: `${inHeight}px`}} className="tabletMenuBlock">
           ...
           <div className="link productLink">
             ...
             <div style={{height: `${productsMenu ? "100px" : "0"}`}} className="productsBlock">
               <div className="productsInsideBlock">
                 <Link onClick={()=>setTabletMenu(false)} className="productsLink" to="/products/electricCars"><TextInView className={`G-20-400-Nexa`} text={t("main.link8")}/></Link>
                 <Link onClick={()=>setTabletMenu(false)} className="productsLink" to="/products/chargerStation"><TextInView className={`G-20-400-Nexa`} text={t("main.link9")}/></Link>
                 <Link onClick={()=>setTabletMenu(false)} className="productsLink" to="/products/solarPanels"><TextInView className={`G-20-400-Nexa`} text={t("main.link10")}/></Link>
               </div>
             </div>
           
           </div>
           
           <Link onClick={()=>setTabletMenu(false)} className="link G-marginR-32" to="/products/rentCar">
         ...
         <div className="UnderRow G-flex-Column G-flex-ACenter">
           {authentication ? <Link onClick={()=>setTabletMenu(false)} to="/profile" className="AccountLink AccountLinkTablet  G-20-400-Nexa G-black"><TextInView text={t("main.account")}/></Link>
            :
           ...
           <Link onClick={()=>setTabletMenu(false)} to="/bookingService" className="settingsCont G-flex-ACenter G-marginB-24">
  ...
  function CartMenuBlock ({state, handleState}){
     ...
     <div className={`Navigation G-Container ${navTheme === "home" ? "homeTheme" : "lightTheme"}`}>
       ...
       <div className="navBlockCont G-flex-ACenter-JBetween">
         ...
         <div className="G-flex-ACenter linksBlock">
           ...
           <Link className="link G-marginR-32" to="/products/rentCar">
             <LinkToPage text={t("main.link3")}/>
           </Link>
         ...
         <div className="G-flex-ACenter">
           ...
           <button onClick={()=>{setCartBlock(prev=>!prev)}} className="cartBtn">
